...
import { CreateProductForm } from '@/components/(Online-Store)/Admin/AdminProductAdd';

import { formatKST } from '@/module/pgAdminHelper';
import { Badge, classNames, SkeletonRow } from '@/components/(Online-Store)/Admin/AdminUI';
import AdminProductDetail from '@/components/(Online-Store)/Admin/AdminProductDetail';
import AdminProductEdit from '@/components/(Online-Store)/Admin/AdminProductEdit';
