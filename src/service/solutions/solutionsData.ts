            ...
            faq: [
                {
                    ...
                    answer: "Global-IoT is a service provided by Korea Orbcomm that leverages global communication networks (cellular, low-earth orbit and geostationary satellites, IoT, etc.) to offer solutions suitable for various industries worldwide."
                },
                {
                    question: "In which industries is Global-IoT used?",
                    answer: "Global-IoT can be utilized in any field that requires data collection and utilization. Key applications include monitoring in heavy machinery (construction/agricultural equipment), marine information (ships, buoys, beacons, etc.), and public and social safety (weather observation, water level monitoring, public safety, etc.)."
                },
                {
                    question: "How is data security ensured?",
                    answer: "All data collected through IoT devices is encrypted before being transmitted to customers. Unauthorized access is prevented through authentication and access control of the communication networks."
                },
                {
                    question: "What are the costs of adopting the Global-IoT service?",
                    answer: "Costs vary depending on the communication network, required devices, and service scale. Customized quotes are provided through consultation."
                },
                {
                    question: "Are there additional costs for service expansion?",
                    answer: "Yes, additional costs may apply for extra devices and network usage. However, we offer flexible pricing plans considering scalability."
                }
            ],
            ctas: {
                title: "When you need a tailored solution, contact us now.",
    ...
    "ko": {
        ...
        "global-iot": {
            ...
            faq: [
                {
                    question: "Global-IoT란 무엇인가요?",
                    answer: "Global-IoT는 코리아오브컴에 제공하는 글로벌 통신망(셀룰러, 저궤도 및 정지궤도 위성망, IoT 등)을 활용하여 세계 다양한 산업 분야에 적합한 솔루션을 제공하는 서비스입니다."
                },
                {
                    question: "Global-Iot는 어떤 산업 분야에서 활용되나요?",
