            ...
            <section className='flex-1 flex flex-col justify-center items-start mb-8 md:mb-0 px-5'>
                ...
                <section className='my-8'>
                    <button
                        ...
                        className='inline-flex items-center px-6 py-3 font-medium text-center rounded-full hover:bg-gray-100 border border-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>
                        <h5 className='text-base text-sm font-semibold text-red-800'>
