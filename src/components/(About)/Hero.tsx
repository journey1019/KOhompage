    ...
    <>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          {/* Customer Logos */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 items-center justify-items-center">
            {/* Korea Coast Guard */}
            <div className="text-gray-400 dark:text-gray-400 filter grayscale brightness-[100%]">
              <Image
                  src="/images/customer/KoreaCoastGuard.png"
                  alt="Korea Coast Guard Logo"
                  unoptimized
                  width={120}
                  height={40}
            ...
            <div className="text-gray-400 dark:text-gray-400 filter grayscale brightness-[100%]">
              <Image
                  src="/images/customer/SINOKOR.png"
                  alt="SINOKOR Logo"
                  unoptimized
                  width={120}
                  height={40}
            ...
            <div className="text-gray-400 dark:text-gray-400 filter grayscale brightness-[100%]">
              <Image
                  src="/images/customer/HYUNDAIAUTOEVER.png"
            ...
            <div className="text-gray-400 dark:text-gray-400 filter grayscale brightness-[100%]">
              <Image
                  src="/images/customer/HanhwaOcean.png"
                  alt="Hanhwa Ocean Logo"
                  unoptimized
                  width={120}
                  height={40}
                  className="object-contain"
