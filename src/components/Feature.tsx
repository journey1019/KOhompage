...
export default function Feature({ sections }: FeatureProps) {
    ...
    return (
        <div className="mx-auto max-w-7xl maxWeb:max-w-screen-2xl px-6 lg:px-8 lg:py-14">
            {sections.map((section, index) => (
                ...
                >
                    ...
                    {/* 텍스트 */}
                    <motion.div
                        className="max-w-xl maxWeb:max-w-screen-2xl lg:max-w-lg mx-auto text-center lg:text-start"
