                    ...
                    <div className="max-w-xl lg:max-w-lg mx-auto text-center lg:text-start">
                        ...
                        <div className="flex flex-col items-center space-y-4 lg:space-y-0 mt-6 lg:flex-row lg:gap-x-5">
                            ...
                            <a
                                href="/contact-us"
                                type="button"
                                className="w-full max-w-xs lg:max-w-[12rem] bg-white font-bold text-red-800 rounded-full border-2 border-red-800 py-3 px-6 sm:px-8 lg:px-10 text-center hover:bg-red-700 hover:border-gray-200 hover:text-white">
                                상담 요청하기
                            </a>
                            {/*<button*/}
