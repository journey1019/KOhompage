            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="border border-gray-300 rounded-lg p-4 lg:p-6 flex flex-col lg:flex-row justify-between">
                    <div className="flex flex-col lg:w-1/2">
                        <span className="bg-indigo-600 text-white rounded-full px-3 py-1 mb-3 w-max">{latestPost.category}</span>
                        ...
                        <button type="button" className="w-1/3 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                            Read More
                        </button>
                    </div>
                    <img
                    ...
                    {otherPosts.map((post) => (
                        <div key={post.id} className="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
                            ...
                            <div className="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
                                <span className={`bg-${post.category === 'BLOG' ? 'blue' : post.category === 'NOTICE' ? 'green' : 'red'}-500 text-white rounded-full px-3 py-1 mb-3 w-max`}>{post.category}</span>
