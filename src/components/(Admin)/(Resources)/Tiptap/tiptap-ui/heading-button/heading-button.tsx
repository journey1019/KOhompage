...
// --- Icons ---
import { HeadingOneIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/heading-six-icon"
