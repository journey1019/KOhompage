...
import { CloseIcon } from "@/components/(Admin)/(Resources)/Tiptap/tiptap-icons/close-icon"
import "@/components/(Admin)/(Resources)/Tiptap/tiptap-node/image-upload-node/image-upload-node.scss"
