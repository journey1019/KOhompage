...
export const CtaSolution: React.FC<CtaProps> = ({ items }) => {
    ...
    return (
        <Container>
            <motion.div
                className={`relative flex flex-wrap items-center justify-between w-full max-w-7xl maxWeb:max-w-screen-2xl gap-5 mx-auto text-white p-7 lg:p-12 maxWeb:p-16 maxWeb:my-10 xl:flex-nowrap rounded-xl ${
            ...
            >
                ...
                >
                    <h2 className="text-2xl font-medium lg:text-3xl maxWeb:text-4xl">{items.title}</h2>
                    <p className="mt-2 font-medium text-white text-opacity-90 lg:text-xl maxWeb:text-2xl">
                        {items.subTitle}
                    </p>
                </motion.div>
                ...
                {items.solutionButton && (
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            className="inline-block py-3 mx-auto text-md lg:text-lg maxWeb:text-xl font-medium text-center text-white bg-red-700 border-2 border-red-700 rounded-md px-7 lg:px-10 lg:py-5 hover:bg-white hover:text-red-800 hover:border-2 hover:border-red-700"
                        >
                            {items.solutionButton}
                        </a>
                    </motion.div>
