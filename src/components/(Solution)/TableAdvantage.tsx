...
const TableAdvantage: React.FC<FeaturesProps> = ({ items }) => {
    ...
    return (
        <section className="bg-white dark:bg-gray-900 mx-auto max-w-7xl maxWeb:max-w-screen-2xl px-6 lg:px-8 lg:pb-40">
            ...
            >
                ...
                >
                    ...
                    {/* Text */}
                    <h2 className="text-lg maxWeb:text-2xl font-semibold text-gray-800 dark:text-white">
                        Faster message delivery speeds
                    </h2>
                    <p className="text-sm maxWeb:text-lg text-gray-600 dark:text-gray-300 mt-2">
                ...
                >
                    <table className="table-auto w-full h-full border-collapse border border-gray-300 dark:border-gray-700">
                        ...
                        <tr className="bg-gray-100 dark:bg-gray-800">
                            <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left text-md maxWeb:text-xl text-gray-700 dark:text-gray-300">
                                Message Size
                            </th>
                            <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left text-md maxWeb:text-xl text-gray-700 dark:text-gray-300">
                                OGx
                        ...
                        {items.map((item, index) => (
                            ...
                            >
                                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-md maxWeb:text-xl text-gray-700 dark:text-gray-300">
                                    {item.messageSize}
                                </td>
                                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-md maxWeb:text-xl text-gray-700 dark:text-gray-300">
                                    {item.ogx}
