export default function BlockQuote() {
    return (
        <section className="dark:bg-gray-900">
            <figure className="max-w-screen-md mx-auto text-center py-36">
                ...
                <blockquote>
                    <p className="text-2xl italic font-medium text-gray-900 dark:text-white">&quot;KOREAORBCOMM is just awesome.
                ...
                <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
                    ...
                    <div
                        ...
                        <cite className="ps-3 text-sm text-gray-500 dark:text-gray-400">CEO at Company</cite>
                    </div>
                </figcaption>
            </figure>
        </section>
